...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 12 + 5/16.0; // in
    ...
    public static double kStatic = 0.0018;
     ...
     * inches.
     */
    public static double MAX_VEL = 53.3257;
    public static double MAX_ACCEL = 30;
    public static double MAX_ANG_VEL = Math.toRadians(13.35);
