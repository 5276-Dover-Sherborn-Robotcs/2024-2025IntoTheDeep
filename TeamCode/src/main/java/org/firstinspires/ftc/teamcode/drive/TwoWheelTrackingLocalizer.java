...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_Y = -1/16.0; // Y is the strafe direction

    public static double PERPENDICULAR_X = -.5 ;
    public static double PERPENDICULAR_Y = -0.25;

    public static double X_MULTIPLIER = 0.98483; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.98658; // Multiplier in the Y direction
